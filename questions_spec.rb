...
describe 'the Friday test :)' do
  ...
  xspecify 'add_together_keys_and_values' do
  ...
  xspecify 'check_a_string_for_special_characters' do
  ...
  xspecify 'your_birthday_is_on_a_friday_in_the_year' do
